...
//   >
//     <span className="text-base">{icon}</span>{label}
//     {disabled && <span className="ml-auto text-[9px] text-white/20 font-medium tracking-wide">SOON</span>}
//   </button>
// );
...
//   const navItems = [
//     { id: 'dashboard', icon: '⊞', label: 'Dashboard', navPath: '/',    disabled: false },
//     { id: 'projects',  icon: '📁', label: 'Projects',  navPath: '/',    disabled: false },
//     { id: 'sprints',   icon: '📅', label: 'Sprints',   navPath: null,   disabled: true  },
//     { id: 'tasks',     icon: '☑',  label: 'My Tasks',  navPath: null,   disabled: true  },
//   ];
//   const workspaceItems = [
//     { id: 'team',     icon: '👥', label: 'Team',     navPath: null, disabled: true },
//     { id: 'reports',  icon: '📊', label: 'Reports',  navPath: null, disabled: true },
//     { id: 'settings', icon: '⚙',  label: 'Settings', navPath: null, disabled: true },
//   ];
...
//                 if (item.navPath) navigate(item.navPath);
//               }}
//             />
//           ))}
//           <div className="h-px bg-white/[0.06] my-2" />
...
const Dashboard = () => {
  ...
  const navItems = [
    { id: 'dashboard', icon: '⊞', label: 'Dashboard', navPath: '/',        disabled: false },
    { id: 'projects',  icon: '📁', label: 'Projects',  navPath: '/',        disabled: false },
    { id: 'sprints',   icon: '📅', label: 'Sprints',   navPath: '/sprints', disabled: false },
    { id: 'tasks',     icon: '☑',  label: 'My Tasks',  navPath: '/my-tasks', disabled: false },
  ];
  const workspaceItems = [
    { id: 'team',     icon: '👥', label: 'Team',     navPath: null, disabled: true },
    { id: 'reports',  icon: '📊', label: 'Reports',  navPath: null, disabled: true },
